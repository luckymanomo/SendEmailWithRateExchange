			...
			while(true){
				try{
					...
					//if(rate!=null){
						...
						String flagBase64="https://upload.wikimedia.org/wikipedia/en/thumb/9/9e/Flag_of_Japan.svg/510px-Flag_of_Japan.svg.png";
						String flagImage="<a href='#' target='_blank'> <img style='display: block; border: none; outline: none; text-decoration: none; border-width: initial;vertical-align: middle;' src='"+flagBase64+"' alt='' width='128' height='84' border='0' /> </a>";
						...
						SiaSendMailTLS.sendMessage(body,toEmails);
